...
Source text: `F:\skills\misra\work\misra-cpp-2023.txt`

These notes summarize how the local skill should use the licensed MISRA C++:2023 material. They are a navigation and operating model, not a reproduction of the standard.
...
- The rule index should be used to locate relevant identifiers and source lines in the local extracted text. Full wording, rationale, examples, and exceptions remain in the licensed source document.
